...
class PreRes2Net(nn.Module):
    def __init__(self, block, layers, baseWidth=26, scale=4, num_classes=1000):
        self.inplanes = 64
        super(PreRes2Net, self).__init__()
...
class knowledge_adaptation_UNet(nn.Module):
    def __init__(self):
        ...
        res2net101 = PreRes2Net(Bottle2neck, [3, 4, 23, 3], baseWidth=26, scale=4)
        res2net101.load_state_dict(torch.load(
            './Ckpt/Pretrained/res2net101_v1b_26w_4s-0812c246.pth',
