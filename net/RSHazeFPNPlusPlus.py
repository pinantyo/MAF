...
from net.common import CMFI, Downsample, OverlapPatchEmbed, SKFusion, ConvBlock, DecoderBlock
...
class RSHazeNet(nn.Module):
    def __init__(self, in_chans=3, out_chans=3, dim=32, depths=(2, 3, 4)):
        ...
        self.skip_connection_level_1_out = nn.Sequential(
    ...
    def forward_features(self, x):
        ...
        x = self.skip_connection_level_1_out(x)
